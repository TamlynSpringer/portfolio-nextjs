      ...
      <ol className="mx-5 lg:mx-0 border-l-2 border-emerald-600">
        <li>
          ...
          <div className="ml-6 mb-6 pb-6">
            <p className="font-bold text-emerald-600 hover:text-emerald-700 focus:text-emerald-800 duration-300 transition ease-in-out text-base pt-2">2023</p>
            <p className="text-gray-700 dark:text-gray-400 mt-2 mb-4">Applied Technology</p>
        ...
        <li>
          ...
          <div className="ml-6 mb-6 pb-6">
            <p className="font-bold text-emerald-600 hover:text-emerald-700 focus:text-emerald-800 duration-300 transition ease-in-out text-base pt-2">2022</p>
        ...
        <div className="flex flex-start items-center">
            <div className="bg-emerald-600 w-4 h-4 flex items-center justify-center rounded-full -ml-2 mr-3 -mt-2"></div>
            <a 
              className='mb-8  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white py-3 px-6 font-medium rounded-3xl'
