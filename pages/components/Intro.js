    ...
    <section className='flex flex-col gap-10 lg:flex-row lg:flex-wrap'>
      <div className='py-4 basis-1/3 flex-1'>
        <div className='text-left py-10 px-4 basis-1/3 flex-1'>
          <h2 className='text-5xl py-4 text-emerald-900 font-medium md:text-6xl lg:text-7xl dark:text-emerald-200'>Hi, I&apos;m Tamlyn Springer</h2>
          <h3 className='py-4 text-3xl lg:text-5xl text-neutral-900 dark:text-neutral-100'>Developer & Designer</h3>
