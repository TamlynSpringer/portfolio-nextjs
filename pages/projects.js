    ...
    <main className=' min-h-screen bg-zinc-100 md:px-20 lg:px:40 dark:bg-zinc-800'>
      ...
      <div className='px-2 flex flex-col gap-10 lg:flex-row lg:flex-wrap'>
        <article className='text-center px-2 my-4 shadow-xl rounded-xl bg-zinc-300 basis-1/3 flex-1 dark:bg-zinc-300'>
          ...
          <p className='text-gray-800 py-4 text-md'><a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://baltic-store.netlify.app/' target='blank'>Site</a> <a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://github.com/TamlynSpringer/eCommerce_Client' target='blank'>FE code</a> <a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://github.com/TamlynSpringer/eCommerce_Server' target='blank'>BE code</a></p>
        </article>
        <article className='text-center px-2 my-4 shadow-xl rounded-xl bg-zinc-300 basis-1/3 flex-1 dark:bg-zinc-300'>
          ...
          <p className='text-gray-800 py-4 text-md'><a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://planetary-facts-1337.netlify.app/' target='blank'>Site</a> <a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://github.com/TamlynSpringer/planetary-facts-vite' target='blank'>Code</a></p>
        </article>
        <article className='text-center px-2 my-4 shadow-xl rounded-xl bg-zinc-300 basis-1/3 flex-1 dark:bg-zinc-300'>
        ...
        <article className='text-center px-2 my-4 shadow-xl rounded-xl bg-zinc-300 basis-1/3 flex-1 dark:bg-zinc-300'>
          ...
          <p className='text-gray-800 py-4 text-md'><a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://react-image-search-gallery.netlify.app/' target='blank'>Site</a> <a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://github.com/TamlynSpringer/image-gallery' target='blank'>Code</a></p>
        </article>
        <article className='text-center px-2 my-4 shadow-xl rounded-xl bg-zinc-300 basis-1/3 flex-1 dark:bg-zinc-300'>
          ...
          <p className='text-gray-800 py-4 text-md'><a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://github.com/TamlynSpringer/React-Native-goals-app' target='blank'>Code</a></p>
        </article>
        <article className='text-center px-2 my-4 shadow-xl rounded-xl bg-zinc-300 basis-1/3 flex-1 dark:bg-zinc-300'>
          ...
          <p className='text-gray-800 py-4 text-md'> <a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://youtu.be/c_A_ctavXEY' target='blank'>Walk-through</a> <a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://github.com/TamlynSpringer/SOUTH-UNO'>Code</a></p>
        </article>
        <article className='text-center px-2 my-4 shadow-xl rounded-xl bg-zinc-300 basis-1/3 flex-1 dark:bg-zinc-300'>
          ...
          <p className='text-gray-800 py-4 text-md'><a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://ts-react-simple-blog.netlify.app/' target='blank'>Site</a> <a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://github.com/TamlynSpringer/blog-typescript-react' target='blank'>Code</a></p>
        </article>
        <article className='text-center px-2 my-4 shadow-xl rounded-xl bg-zinc-300 basis-1/3 flex-1 dark:bg-zinc-300'>
          ...
          <p className='text-gray-800 py-4 text-md'><a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://github.com/TamlynSpringer/typescript-react-puppies' target='blank'>FE Code</a> <a className='ml-2  bg-gradient-to-r from-emerald-900 to-emerald-600 text-white px-4 py-2 font-medium rounded-3xl' href='https://github.com/TamlynSpringer/typescript-puppies-api' target='blank'>BE Code</a></p>
        </article>
        <article className=' text-center px-2 my-4 shadow-xl rounded-xl bg-zinc-300 basis-1/3 flex-1 dark:bg-zinc-300'>
