    ...
    <div className="flex flex-col gap-10 lg:flex-row lg:flex-wrap">
        ...
        <ol className="mx-5 lg:mx-0 border-l-2 border-green-900">
          <li>
            <div className="flex flex-start items-center">
              ...
              <h4 className="text-neutral-800 dark:text-neutral-200 font-semibold text-xl -mt-2">Senior full-stack product developer</h4>
            </div>
            <div className="ml-6 mb-6 pb-6">
              <p className="font-bold text-neutral-700 dark:text-neutral-200 text-base pt-2">2025</p>
              <p className="text-neutral-700 dark:text-neutral-200 mt-2 mb-4">Bytespoke (formerly Arrixa)</p>
            </div>
          </li>
          <li>
            <div className="flex flex-start items-center">
              <div className="bg-green-900 w-4 h-4 flex items-center justify-center rounded-full -ml-2 mr-3 -mt-2"></div>
              <h4 className="text-neutral-800 dark:text-neutral-200 font-semibold text-xl -mt-2">Full-stack product developer</h4>
            </div>
            <div className="ml-6 mb-6 pb-6">
              <p className="font-bold text-neutral-700 dark:text-neutral-200 text-base pt-2">2024</p>
              <p className="text-neutral-700 dark:text-neutral-200 mt-2 mb-4">Arrixa</p>
            </div>
          </li>
          <li>
            <div className="flex flex-start items-center">
          ...
          <li>
            ...
            <div className="ml-6 mb-6 pb-6">
              <p className="font-bold text-neutral-700 dark:text-neutral-200 text-base pt-2">2019 - 2021</p>
      ...
      <section className="mx-auto py-4 basis-1/3 flex-1">
        <div className="relative">
          <Image src={"/profile_img.png"} alt="Profile photo" width={500} height={500} className="mb-10 w-36 h-36 lg:w-52 lg:h-52" />
          <Image src={"/fern.svg"} width={500} height={500} alt="Fern image" className="h-44 w-24 -bottom-12  left-32 lg:h-60 lg:w-40 absolute lg:-bottom-10 lg:left-60 text-neutral-900" />
        </div>
